...
public class CardStackView extends FrameLayout {
    ...
    private CardContainerView.ContainerEventListener containerEventListener = new CardContainerView.ContainerEventListener() {
        ...
        @Override
        public void onContainerSwiped(Point point, com.yuyakaido.android.cardstackview.SwipeDirection direction) {
    ...
    public CardStackView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, com.dev.skillconnect.R.styleable.CardStackView);
        setVisibleCount(array.getInt(com.dev.skillconnect.R.styleable.CardStackView_visibleCount, option.visibleCount));
        setSwipeThreshold(array.getFloat(com.dev.skillconnect.R.styleable.CardStackView_swipeThreshold, option.swipeThreshold));
        setTranslationDiff(array.getFloat(com.dev.skillconnect.R.styleable.CardStackView_translationDiff, option.translationDiff));
        setScaleDiff(array.getFloat(com.dev.skillconnect.R.styleable.CardStackView_scaleDiff, option.scaleDiff));
        setStackFrom(StackFrom.values()[array.getInt(com.dev.skillconnect.R.styleable.CardStackView_stackFrom, option.stackFrom.ordinal())]);
        setElevationEnabled(array.getBoolean(com.dev.skillconnect.R.styleable.CardStackView_elevationEnabled, option.isElevationEnabled));
        setSwipeEnabled(array.getBoolean(com.dev.skillconnect.R.styleable.CardStackView_swipeEnabled, option.isSwipeEnabled));
        setSwipeDirection(SwipeDirection.from(array.getInt(com.dev.skillconnect.R.styleable.CardStackView_swipeDirection, 0)));
        setLeftOverlay(array.getResourceId(com.dev.skillconnect.R.styleable.CardStackView_leftOverlay, 0));
        setRightOverlay(array.getResourceId(com.dev.skillconnect.R.styleable.CardStackView_rightOverlay, 0));
        setBottomOverlay(array.getResourceId(com.dev.skillconnect.R.styleable.CardStackView_bottomOverlay, 0));
        setTopOverlay(array.getResourceId(com.dev.skillconnect.R.styleable.CardStackView_topOverlay, 0));
        array.recycle();
    }
    ...
    private void initializeViews() {
        ...
        for (int i = 0; i < option.visibleCount; i++) {
            CardContainerView view = (CardContainerView) LayoutInflater.from(getContext())
                    .inflate(com.dev.skillconnect.R.layout.card_container, this, false);
    ...
    private void update(float percentX, float percentY) {
        ...
        for (int i = 1; i < option.visibleCount; i++) {
            ...
            if (StackFrom.Top == option.stackFrom) {
